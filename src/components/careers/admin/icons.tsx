// Outline icons for the careers admin UI (Heroicons v2 outline paths, MIT licensed).
// Icons are decorative: they are hidden from assistive technology, so every icon-only
...
function Svg({ className = "adm-icon", strokeWidth = 2, children }: IconProps & { children: ReactNode }) {
  return (
    <svg
...
export function IconIdentification(props: IconProps) {
  return (
    <Svg {...props}>
...
export function IconUserGroup(props: IconProps) {
  return (
    <Svg {...props}>
