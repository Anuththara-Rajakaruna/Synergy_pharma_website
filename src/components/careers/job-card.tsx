...
import { MapPin, BriefcaseBusiness, ArrowUpRight, Banknote } from "lucide-react";
  ...
  return (
    ...
    >
      <Link
        ...
        className="group flex w-full overflow-hidden rounded-[28px] border border-[#dceaf3] bg-white px-6 py-5 text-left shadow-[0_16px_34px_rgba(17,58,83,0.08)] outline-none transition-all duration-300 hover:border-[#87c3e5] hover:bg-[linear-gradient(180deg,#ffffff_0%,#f8fcff_100%)] hover:shadow-[0_24px_42px_rgba(17,58,83,0.14)] focus-visible:ring-2 focus-visible:ring-[#1075bd] focus-visible:ring-offset-2 md:px-7 md:py-5"
      >
        ...
        <div className="flex w-full flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-7">
          ...
          <div className="flex shrink-0 flex-col gap-3 lg:w-52.5 lg:items-end">
            ...
            <div className="w-full translate-y-0.5 opacity-100 transition-all duration-300 lg:opacity-95 lg:group-hover:-translate-y-0.5 lg:group-hover:opacity-100">
